...
public class SignatureUtil {
	...
	public SignatureUtil() {
		try {
			...
			String path = java.net.URLDecoder.decode(SignatureUtil.class.getResource("/").getPath(), "utf-8");// 证书路径
	...
	*/
	...
	public static void main(String[] args)throws IOException {
		SignatureUtil signToolManage = new SignatureUtil();// 创建一个实例
		/**
		*组织报文，报文格式根据文档规定组织
		*/
		...
		//验签
		try {
			new SignatureUtil().verifySign(signData, toPayData, null);
